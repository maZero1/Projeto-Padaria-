...
public class VendaPanel extends JPanel {
    ...
    public VendaPanel(AppController app) {
        this.app = app;
    ...
    public void carregarCombos() {
        ...
        for (Cliente c : app.clientes().findAll()) cbCliente.addItem(c);

        cbProduto.removeAllItems();
        for (Produto p : app.produtos().findAll()) cbProduto.addItem(p);
    }
    ...
    private void adicionarItem() {
        if (vendaAtual == null) { JOptionPane.showMessageDialog(this, "Clique em 'Nova Venda' primeiro."); return; }
    ...
    private void finalizar() {
        if (vendaAtual == null) { JOptionPane.showMessageDialog(this, "Nenhuma venda atual."); return; }
        try {
